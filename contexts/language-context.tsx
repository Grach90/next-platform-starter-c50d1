...
const mockTranslations = {
  [ELanguage.English]: {
    ...
    "hero.choose": "Choose",
    "hero.search...": "Search...",
    "hero.Order": "ORDER / CATALOG",
    "hero.aboutus": "About Us | Delivery | Payment",
...
Need help? Our team is always available on WhatsApp to answer questions and assist with your order — quickly and personally`,
  ...
  [ELanguage.Russian]: {
    ...
    "hero.choose": "Выбрать",
    "hero.search...": "Поиск...",
    "hero.Order": "ЗАКАЗ / КАТАЛОГ",
    "hero.aboutus": "О НАС | Доставка | Оплата",
...
чтобы ответить на все вопросы и помочь с оформлением.`,
  ...
  [ELanguage.Arabic]: {
    ...
    "hero.choose": "يختار",
    "hero.search...": "يبحث...",
    "hero.Order": "طلب / كتالوج",
    "hero.aboutus": "معلومات عنا | توصيل | قسط",
